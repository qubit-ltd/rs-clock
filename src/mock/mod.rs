...
//! elapsed-time source. [`MockClock`] maps that elapsed time onto UTC
//! wall-clock readings, while [`crate::sleep::MockSleeper`] turns relative
//! sleeps into waits on the same timeline. [`MockTime`] is the convenience
//! facade for the common case where one test needs a clock and a sleeper that
//! advance together.
//!
