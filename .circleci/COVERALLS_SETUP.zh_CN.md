...
本文档说明如何为 `rust-clock` 项目配置 Coveralls.io 代码覆盖率服务。
...
1. 访问 CircleCI 项目设置：
   ```
   https://app.circleci.com/settings/project/github/qubit-ltd/rust-clock
   ```
...
2. 访问 Coveralls 仪表板：
   ```
   https://coveralls.io/github/qubit-ltd/rust-clock
   ```
3. 查看覆盖率报告 🎉
